...
export const usersToClinicsTablesRelations = relations(usersToClinicsTable, ({ one }) => ({
  user: one(usersTable, {
...
export const doctorsTablesRelations = relations(doctorsTable, ({ many, one }) => ({
  clinic: one(clinicsTable, {
...
export const patientsTablesRelations = relations(patientsTable, ({ many, one }) => ({
  clinic: one(clinicsTable, {
...
export const appointmentsTablesRelations = relations(appointmentsTable, ({ one }) => ({
  clinic: one(clinicsTable, {
